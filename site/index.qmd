...
listing:
  ...
  - id: support
    ...
    - path: https://www.uu.nl/en/research/digital-competence-center
      ...
      title: "**UU DCC**"
      description: "The Utrecht University DCC (Digital Competence Center) is the network of all support teams at Utrecht University for help with research data, software, and infrastructure. We exist to traverse borders, increase visibility, and experience a sense of community in co-creating digital competencies to support research at Utrecht University. "
    - path: https://www.esciencecenter.nl/
      image: https://research-software-directory.org/image/rpc/get_image?uid=84105fcfd3f960ef7238cc696b38cd6e742684e1
      title: "**eScience center**"
      description: "The Netherlands eScience Center is the Netherlands’ national centre for research software. As an independent foundation with around 100 passionate people, we empower researchers and challenge them to do ‘eScience’ better or differently.   "
    type: grid
    categories: false
    max-items: 4
    grid-columns: 2
...
Are you ready to boost your skills in scientific computation, parallel programming, and High Performance Computing? Then please take part in the HPC Spring School at Utrecht University!

During this Spring School, experts from the UU and SURF offer a wide range of sessions spread over ten days.
